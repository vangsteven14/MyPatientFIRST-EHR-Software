...
class ConnectDatabasePatients(ConnectDatabase): 
    ...
    def update_info(self, old_patient_id=None, new_patient_id=None, last_name=None, first_name=None, sex=None, age=None, birth_date=None, medications=None, email_address=None):
        ...
        if new_patient_id and new_patient_id != old_patient_id:
            conditions.append(f"patientID = '{new_patient_id}'")
        if last_name:
        ...
        sql = f"""
            ...
            SET {", ".join(conditions)}
            WHERE patientID = {old_patient_id}
        """
