...
class LoginWindow(QWidget):
    def __init__(self):
        ...
        button_login = QPushButton("Sign in", clicked=self.checkCredentials)
...
class LogoutWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MyPatientFirst")
        self.setWindowIcon(QIcon(ResourceLoader.resource_path("icons/MyPatientFirstLogo_Symbol.JPG")))
        ...
        logout_label = QLabel("Signing out...\n\nPlease wait...")
        logout_label.setStyleSheet("font-family: Verdana; font-size: 1.5em; color: black;")
        logout_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        layout.addWidget(logout_label, 0, 0)

        QTimer.singleShot(3000, self.go_to_login)
