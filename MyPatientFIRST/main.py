...
from connect_fonts import load_google_fonts                     
...
class MainWindow(QMainWindow):
        ...
        def display_home_page(self):
            customFontWelcome = QFontDatabase.addApplicationFont("fonts/Poppins-ExtraBold.ttf")
            customFontTitle = QFontDatabase.addApplicationFont("fonts/Poppins-ExtraBold.ttf")
            customFont = QFontDatabase.addApplicationFont("fonts/Poppins-Light.ttf")
            ...
            self.ui.visits_label_1.setFixedWidth(200)

        def display_fonts_ui(self):
            customFont_poppins = QFontDatabase.addApplicationFont("fonts/Poppins-Light.ttf")
        ...
        def get_patient_info(self,):
            ...
            '''birth_date_value = (
                ...
                if self.birth_date.date() != QDate(1900, 1, 1)
                else ""
            )'''
            birth_date = self.birth_date.date().toString("yyyy-MM-dd")
...
if __name__ == '__main__':
    ...
    font_path = os.path.join("fonts", "Poppins-Light.ttf")
    custom_font = load_google_fonts(font_path)
