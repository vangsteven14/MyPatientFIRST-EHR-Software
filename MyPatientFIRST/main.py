...
class MainWindow(QMainWindow):
        def __init__(self):
            ...
            # Allows only 3-digit numbers for BillingID which restricts input to integers
            self.billing_id = self.ui.billingslineEdit_1
        ...
        # Function to fetch patient IDs from the database and populate into combo box in visits table.
        def populate_patient_ids_billings(self):                            # Still in progress
            pass
