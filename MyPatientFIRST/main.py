...
class MainWindow(QMainWindow):
        ...
        def openViewPatientProfile(self):
            ...
            self.ui = Ui_ViewPatientProfile()
            self.view_patient_window.setWindowIcon(QIcon("icons/MyPatientFirstLogo_Symbol.JPG"))
            self.ui = Ui_ViewPatientProfile()
            self.ui.setupUi(self. view_patient_window)

            # Connects to View Patient Profile buttons to function
            self.ui.patSearch_btn.clicked.connect(self.search_patSearch_profile)
            self.ui.patClear_btn.clicked.connect(self.pat_clear_info)

            # SHows the View Patient Profile window/dialog box
            self.view_patient_window.show()

        def search_patSearch_profile(self):
            patient_id = self.ui.patSearch_lineEdit.text().strip()
            ...
            #print("Data Type:", type(patSearch_patientData))
            '''
            if isinstance(patSearch_patientData, list):
            ...
            self.ui.patSearch_lineEdit_1.setText(str(patSearch_patientData["lastName"])) 
            self.ui.patSearch_lineEdit_2.setText(str(patSearch_patientData["firstName"]))  
            self.ui.patSearch_lineEdit_3.setText(str(patSearch_patientData["patientID"])) 
            self.ui.patSearch_lineEdit_4.setText(str(patSearch_patientData["sex"]))  
            self.ui.patSearch_lineEdit_5.setText(str(patSearch_patientData["age"]))
            self.ui.patSearch_lineEdit_6.setText(str(patSearch_patientData["emailAddress"]))  
            self.ui.patSearch_lineEdit_7.setText(str(patSearch_patientData["medications"]))

            # Convert birthDate properly
            self.ui.patSearch_dateEdit.setDate(QDate(patSearch_patientData["birthDate"].year, 
        ...
        def pat_clear_info(self, patient_id):
            # Function to clear all patient information in the view patient profile window
            self.ui.patSearch_lineEdit.clear()
            self.ui.patSearch_lineEdit_1.clear()
            self.ui.patSearch_lineEdit_2.clear() 
            self.ui.patSearch_lineEdit_3.clear() 
            self.ui.patSearch_dateEdit.setDate(QDate.currentDate())
            self.ui.patSearch_lineEdit_4.clear() 
            self.ui.patSearch_lineEdit_5.clear()  
            self.ui.patSearch_lineEdit_6.clear()  
            self.ui.patSearch_lineEdit_7.clear()
