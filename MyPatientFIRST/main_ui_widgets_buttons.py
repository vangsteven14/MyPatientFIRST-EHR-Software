...
class MainUIWidgetsButtons():
    ...
    def load_hide_icons(self):
        pixmap = QPixmap(ResourceLoader.resource_path("icons/MyPatientFirstLogo_Symbol.JPG"))
        self.ui.logo_1.setPixmap(pixmap)
        self.ui.home_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/home.svg')))
        self.ui.patient_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/patient.svg')))
        self.ui.visit_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/visit.svg')))
        self.ui.billings_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/billings.svg')))
        self.ui.exit_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/exit.svg')))
        self.ui.menu_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/menu.svg')))

    def load_show_icons(self):
        pixmap = QPixmap(ResourceLoader.resource_path("icons/MyPatientFirstLogo_Symbol.JPG"))
        self.ui.logo_2.setPixmap(pixmap)
        self.ui.home_btn_2.setIcon(QIcon(ResourceLoader.resource_path('icons/home.svg')))
        self.ui.patient_btn_2.setIcon(QIcon(ResourceLoader.resource_path('icons/patient.svg')))
        self.ui.visit_btn_2.setIcon(QIcon(ResourceLoader.resource_path('icons/visit.svg')))
        self.ui.billings_btn_2.setIcon(QIcon(ResourceLoader.resource_path('icons/billings.svg')))
        self.ui.exit_btn_2.setIcon(QIcon(ResourceLoader.resource_path('icons/exit.svg')))
        self.ui.menu_btn_1.setIcon(QIcon(ResourceLoader.resource_path('icons/menu.svg')))
