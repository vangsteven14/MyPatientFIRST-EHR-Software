...
class ConnectDatabaseBillings(ConnectDatabase): 
    ...
    def add_info(self, billing_id, patient_id, visit_id, amount, status, doctor, service, reason):
    ...
    def search_info(self, billing_id=None, patient_id=None, visit_id=None, amount=None, status=None, doctor=None, service=None, reason=None):
        # Connect to the database
        self.connect_db()
