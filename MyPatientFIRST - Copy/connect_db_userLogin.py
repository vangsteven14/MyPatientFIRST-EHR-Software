...
class CreateAccountWindow(QWidget):
    def __init__(self, db_connection=None):
        ...
        layout.addWidget(self.new_userId_label,     0, 0, 1, 1)
        layout.addWidget(self.new_userId_edit,      0, 1, 1, 3)
        layout.addWidget(self.new_username_label,   1, 0, 1, 1)
        layout.addWidget(self.new_username_edit,    1, 1, 1, 3)
        layout.addWidget(self.new_password_label,   2, 0, 1, 1)
        layout.addWidget(self.new_password_edit,    2, 1, 1, 3)
        layout.addWidget(self.submit_button,        3, 2, 1, 2)
    ...
    def createAccount(self):
        ...
        if not new_id or not new_username or not new_password:
            QMessageBox.warning(self, "Input Error", "Both username and password are required for account creation.")
            return
